 ...
 * limitations under the License.
 */
class fh{get(){return"undefined"!=typeof navigator&&navigator&&"onLine"in navigator&&"boolean"==typeof navigator.onLine&&(hh()||Ni()||"connection"in navigator)&&!navigator.onLine?Math.min(5e3,this.shortDelay):this.isMobile?this.longDelay:this.shortDelay}constructor(e,t){this.shortDelay=e,this.longDelay=t,ah(t>e,"Short delay should be less than long delay!"),this.isMobile=Ai()||Oi()}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Rh(e,t,n=!1){if(n)return t;try{return await t}catch(t){throw t instanceof Hi&&function({code:e}){return"auth/user-disabled"===e||"auth/user-token-expired"===e}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Bh(e){const t=e.toLowerCase();if(t.includes("opera/")||t.includes("opr/")||t.includes("opios/"))return"Opera";if(Hh(t))return"IEMobile";if(t.includes("msie")||t.includes("trident/"))return"IE";if(t.includes("edge/"))return"Edge";if(jh(t))return"Firefox";if(t.includes("silk/"))return"Silk";if(Wh(t))return"Blackberry";if(zh(t))return"Webos";if(qh(t))return"Safari";if((t.includes("chrome/")||$h(t))&&!t.includes("edge/"))return"Chrome";if(Vh(t))return"Android";{const t=/([a-zA-Z\d\.]+)\/[a-zA-Z\d\.]*$/,n=e.match(t);if(2===(null==n?void 0:n.length))return n[1]}return"Other"}function jh(e=Ri()){return/firefox\//i.test(e)}function qh(e=Ri()){const t=e.toLowerCase();return t.includes("safari/")&&!t.includes("chrome/")&&!t.includes("crios/")&&!t.includes("android")}function $h(e=Ri()){return/crios\//i.test(e)}function Hh(e=Ri()){return/iemobile/i.test(e)}function Vh(e=Ri()){return/android/i.test(e)}function Wh(e=Ri()){return/blackberry/i.test(e)}function zh(e=Ri()){return/webos/i.test(e)}function Kh(e=Ri()){return/iphone|ipad|ipod/i.test(e)||/macintosh/i.test(e)&&/mobile/i.test(e)}function Gh(e=Ri()){return/(iPad|iPhone|iPod).*OS 7_\d/i.test(e)||/(iPad|iPhone|iPod).*OS 8_\d/i.test(e)}function Yh(e=Ri()){return Kh(e)||Vh(e)||zh(e)||Wh(e)||/windows phone/i.test(e)||Hh(e)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function Jh(e,t=[]){let n;switch(e){case"Browser":n=Bh(Ri());break;case"Worker":n=`${Bh(Ri())}-${e}`;break;default:n=e}const i=t.length?t.join(","):"FirebaseCore-web";return`${n}/JsCore/${is}/${i}`}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xd(e,t,n=!1){const i="signIn",r=await Rd(e,i,t),s=await Sd._fromIdTokenResponse(e,i,r);return n||await e._updateCurrentUser(s.user),s}async function Dd(e,t){return xd(Zh(e),t)}async function Md(e,t){const n=fr(e);return await Od(!1,n,t.providerId),Nd(n,t)}async function Ud(e,t){return Ld(fr(e),t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Vf{execute(){return new Promise((async(e,t)=>{this.pendingPromise={resolve:e,reject:t};try{this.eventManager=await this.resolver._initialize(this.auth),await this.onExecution(),this.eventManager.registerConsumer(this)}catch(e){this.reject(e)}}))}async onAuthEvent(e){const{urlResponse:t,sessionId:n,postBody:i,tenantId:r,error:s,type:o}=e;if(s)return void this.reject(s);const a={auth:this.auth,requestUri:t,sessionId:n,tenantId:r||void 0,postBody:i||void 0,user:this.user,bypassAuthState:this.bypassAuthState};try{this.resolve(await this.getIdpTask(o)(a))}catch(e){this.reject(e)}}onError(e){this.reject(e)}getIdpTask(e){switch(e){case"signInViaPopup":case"signInViaRedirect":return qf;case"linkViaPopup":case"linkViaRedirect":return Hf;case"reauthViaPopup":case"reauthViaRedirect":return $f;default:eh(this.auth,"internal-error")}}resolve(e){ah(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.resolve(e),this.unregisterAndCleanUp()}reject(e){ah(this.pendingPromise,"Pending promise was never set"),this.pendingPromise.reject(e),this.unregisterAndCleanUp()}unregisterAndCleanUp(){this.eventManager&&this.eventManager.unregisterConsumer(this),this.pendingPromise=null,this.cleanUp()}constructor(e,t,n,i,r=!1){this.auth=e,this.resolver=n,this.user=i,this.bypassAuthState=r,this.pendingPromise=null,this.eventManager=null,this.filter=Array.isArray(t)?t:[t]}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
const Tp=ji("authIdTokenMaxAge")||300;let Rp=null;var Ap;
/**
 * @license
 * Copyright 2021 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function $p(){var e;return(null===(e=null===self||void 0===self?void 0:self.location)||void 0===e?void 0:e.protocol)||null}function Hp(e=Ri()){return!("file:"!==$p()&&"ionic:"!==$p()&&"capacitor:"!==$p()||!e.toLowerCase().match(/iphone|ipad|ipod|android/))}function Vp(e=Ri()){return Li()&&11===(null===document||void 0===document?void 0:document.documentMode)||function(e=Ri()){return/Edge\/\d+/.test(e)}(e)}function Wp(){try{const e=self.localStorage,t=gf();if(e)return e.setItem(t,"1"),e.removeItem(t),!Vp()||Di()}catch(e){return zp()&&Di()}return!1}function zp(){return void 0!==e&&"WorkerGlobalScope"in e&&"importScripts"in e}function Kp(){return("http:"===$p()||"https:"===$p()||Ni()||Hp())&&!(Oi()||Pi())&&Wp()&&!zp()}function Gp(){return Hp()&&"undefined"!=typeof document}
/**
 * @license
 * Copyright 2020 Google LLC
 *
