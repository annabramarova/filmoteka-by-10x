 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const vu=new class{getCompleteChild(e){return null}getChildAfterChild(e,t,n){return null}};class bu{getCompleteChild(e){const t=this.viewCache_.eventCache;if(t.isCompleteForChild(e))return t.getNode().getImmediateChild(e);{const t=null!=this.optCompleteServerCache_?new Da(this.optCompleteServerCache_,!0,!1):this.viewCache_.serverCache;return fu(this.writes_,e,t)}}getChildAfterChild(e,t,n){const i=null!=this.optCompleteServerCache_?this.optCompleteServerCache_:$a(this.viewCache_),r=du(this.writes_,i,t,1,n,e);return 0===r.length?null:r[0]}constructor(e,t,n=null){this.writes_=e,this.viewCache_=t,this.optCompleteServerCache_=n}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let Wu=1;class zu{constructor(e){this.listenProvider_=e,this.syncPointTree_=new Va(null),this.pendingWriteTree_={visibleWrites:Wa.empty(),allWrites:[],lastWriteId:-1},this.tagToQueryMap=new Map,this.queryToTagMap=new Map}}function Ku(e,t,n,i,r){return function(e,t,n,i,r){yi(i>e.lastWriteId,"Stacking an older write on top of newer ones"),void 0===r&&(r=!0),e.allWrites.push({path:t,snap:n,writeId:i,visible:r}),r&&(e.visibleWrites=za(e.visibleWrites,t,n)),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i,r),r?nc(e,new La({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,n)):[]}function Gu(e,t,n,i){!function(e,t,n,i){yi(i>e.lastWriteId,"Stacking an older merge on top of newer ones"),e.allWrites.push({path:t,children:n,writeId:i,visible:!0}),e.visibleWrites=Ka(e.visibleWrites,t,n),e.lastWriteId=i}(e.pendingWriteTree_,t,n,i);const r=Va.fromObject(n);return nc(e,new xa({fromUser:!0,fromServer:!1,queryId:null,tagged:!1},t,r))}function Yu(e,t,n=!1){const i=function(e,t){for(let n=0;n<e.allWrites.length;n++){const i=e.allWrites[n];if(i.writeId===t)return i}return null}(e.pendingWriteTree_,t);if(iu(e.pendingWriteTree_,t)){let t=new Va(null);return null!=i.snap?t=t.set(vo(),!0):Hs(i.children,(e=>{t=t.set(new mo(e),!0)})),nc(e,new Na(i.path,t,n))}return[]}function Ju(e,t,n){return nc(e,new La({fromUser:!1,fromServer:!0,queryId:null,tagged:!1},t,n))}function Xu(e,t,n,i,r=!1){const s=t._path,o=e.syncPointTree_.get(s);let a=[];if(o&&("default"===t._queryIdentifier||$u(o,t))){const u=Fu(o,t,n,i);0===o.views.size&&(e.syncPointTree_=e.syncPointTree_.remove(s));const c=u.removed;if(a=u.events,!r){const n=-1!==c.findIndex((e=>e._queryParams.loadsAllData())),r=e.syncPointTree_.findOnPath(s,((e,t)=>Hu(t)));if(n&&!r){const t=e.syncPointTree_.subtree(s);if(!t.isEmpty()){const n=function(e){return e.fold(((e,t,n)=>{if(t&&Hu(t)){return[Vu(t)]}{let e=[];return t&&(e=Bu(t)),Hs(n,((t,n)=>{e=e.concat(n)})),e}}))}(t);for(let t=0;t<n.length;++t){const i=n[t],r=i.query,s=sc(e,i);e.listenProvider_.startListening(hc(r),oc(e,r),s.hashFn,s.onComplete)}}}if(!r&&c.length>0&&!i)if(n){const n=null;e.listenProvider_.stopListening(hc(t),n)}else c.forEach((t=>{const n=e.queryToTagMap.get(ac(t));e.listenProvider_.stopListening(hc(t),n)}))}!function(e,t){for(let n=0;n<t.length;++n){const i=t[n];if(!i._queryParams.loadsAllData()){const t=ac(i),n=e.queryToTagMap.get(t);e.queryToTagMap.delete(t),e.tagToQueryMap.delete(n)}}}(e,c)}return a}function Qu(e,t,n,i){const r=uc(e,i);if(null!=r){const i=cc(r),s=i.path,o=i.queryId,a=ko(s,t);return lc(e,s,new La(Pa(o),a,n))}return[]}function Zu(e,t,n,i=!1){const r=t._path;let s=null,o=!1;e.syncPointTree_.foreachOnPath(r,((e,t)=>{const n=ko(e,r);s=s||ju(t,n),o=o||Hu(t)}));let a,u=e.syncPointTree_.get(r);if(u?(o=o||Hu(u),s=s||ju(u,vo())):(u=new xu,e.syncPointTree_=e.syncPointTree_.set(r,u)),null!=s)a=!0;else{a=!1,s=oa.EMPTY_NODE;e.syncPointTree_.subtree(r).foreachChild(((e,t)=>{const n=ju(t,vo());n&&(s=s.updateImmediateChild(e,n))}))}const c=$u(u,t);if(!c&&!t._queryParams.loadsAllData()){const n=ac(t);yi(!e.queryToTagMap.has(n),"View does not exist, but we have a tag");const i=Wu++;e.queryToTagMap.set(n,i),e.tagToQueryMap.set(i,n)}let l=Uu(u,t,n,nu(e.pendingWriteTree_,r),s,a);if(!c&&!o&&!i){const n=qu(u,t);l=l.concat(function(e,t,n){const i=t._path,r=oc(e,t),s=sc(e,n),o=e.listenProvider_.startListening(hc(t),r,s.hashFn,s.onComplete),a=e.syncPointTree_.subtree(i);if(r)yi(!Hu(a.value),"If we're adding a query, it shouldn't be shadowed");else{const t=a.fold(((e,t,n)=>{if(!So(e)&&t&&Hu(t))return[Vu(t).query];{let e=[];return t&&(e=e.concat(Bu(t).map((e=>e.query)))),Hs(n,((t,n)=>{e=e.concat(n)})),e}}));for(let n=0;n<t.length;++n){const i=t[n];e.listenProvider_.stopListening(hc(i),oc(e,i))}}return o}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
class jc{constructor(){this.eventLists_=[],this.recursionDepth_=0}}function qc(e,t){let n=null;for(let i=0;i<t.length;i++){const r=t[i],s=r.getPath();null===n||Ro(s,n.path)||(e.eventLists_.push(n),n=null),null===n&&(n={events:[],path:s}),n.events.push(r)}n&&e.eventLists_.push(n)}function $c(e,t,n){qc(e,n),Hc(e,(e=>Ao(e,t)||Ao(t,e)))}function Hc(e,t){e.recursionDepth_++;let n=!0;for(let i=0;i<e.eventLists_.length;i++){const r=e.eventLists_[i];if(r){t(r.path)?(Vc(e.eventLists_[i]),e.eventLists_[i]=null):n=!1}}n&&(e.eventLists_=[]),e.recursionDepth_--}function Vc(e){for(let t=0;t<e.events.length;t++){const n=e.events[t];if(null!==n){e.events[t]=null;const i=n.getEventRunner();As&&Os("event: "+n.toString()),Ks(i)}}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */();new qn;u.myLibraryLink.addEventListener("click",(function(e){e.preventDefault(),u.header.classList.add("header--my-library"),u.homeLink.classList.remove("current"),Ol(e),u.formSearch.classList.add("visually-hidden"),u.headerButtons.forEach((e=>{e.classList.remove("visually-hidden")})),u.watchedButton.click()})),u.headerButtons[0].addEventListener("click",(function(e){u.queueButton.classList.remove("current"),Ol(e),Pl="watched",Xg()})),u.headerButtons[1].addEventListener("click",(function(e){u.headerButtons[0].classList.remove("current"),Ol(e),Pl="queue",Qg()}));let Pl="home";const Nl=()=>Pl;function Ol(e){e.target.classList.add("current"),e.target.blur()}function Ll(e){e.preventDefault(),Pl="home",u.header.classList.remove("header--my-library"),u.myLibraryLink.classList.remove("current"),Ol({target:u.homeLink}),u.formSearch.classList.remove("visually-hidden"),u.formSearch.reset(),u.headerButtons.forEach((e=>{e.classList.add("visually-hidden")})),Yg()}u.homeLink.addEventListener("click",Ll),u.logo.addEventListener("click",Ll);
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function xh(e){var t;const n=e.auth,i=await e.getIdToken(),r=await Nh(e,async function(e,t){return Ih(e,"POST","/v1/accounts:lookup",t)}(n,{idToken:i}));uh(null==r?void 0:r.users.length,n,"internal-error");const s=r.users[0];e._notifyReloadListener(s);const o=(null===(t=s.providerUserInfo)||void 0===t?void 0:t.length)?s.providerUserInfo.map((e=>{var{providerId:t}=e,n=Bl(e,["providerId"]);return{providerId:t,uid:n.rawId||"",displayName:n.displayName||null,email:n.email||null,phoneNumber:n.phoneNumber||null,photoURL:n.photoUrl||null}})):[];const a=(u=e.providerData,c=o,[...u.filter((e=>!c.some((t=>t.providerId===e.providerId)))),...c]);var u,c;const l=e.isAnonymous,h=!(e.email&&s.passwordHash||(null==a?void 0:a.length)),d=!!l&&h,f={uid:s.localId,displayName:s.displayName||null,photoURL:s.photoUrl||null,email:s.email||null,emailVerified:s.emailVerified||!1,phoneNumber:s.phoneNumber||null,tenantId:s.tenantId||null,providerData:a,metadata:new Lh(s.createdAt,s.lastLoginAt),isAnonymous:d};Object.assign(e,f)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class Dh{get isExpired(){return!this.expirationTime||Date.now()>this.expirationTime-3e4}updateFromServerResponse(e){uh(e.idToken,"internal-error"),uh(void 0!==e.idToken,"internal-error"),uh(void 0!==e.refreshToken,"internal-error");const t="expiresIn"in e&&void 0!==e.expiresIn?Number(e.expiresIn):function(e){const t=Ph(e);return uh(t,"internal-error"),uh(void 0!==t.exp,"internal-error"),uh(void 0!==t.iat,"internal-error"),Number(t.exp)-Number(t.iat)}(e.idToken);this.updateTokensAndExpiration(e.idToken,e.refreshToken,t)}async getToken(e,t=!1){return uh(!this.accessToken||this.refreshToken,e,"user-token-expired"),t||!this.accessToken||this.isExpired?this.refreshToken?(await this.refresh(e,this.refreshToken),this.accessToken):null:this.accessToken}clearRefreshToken(){this.refreshToken=null}async refresh(e,t){const{accessToken:n,refreshToken:i,expiresIn:r}=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */()}function sd(e){const t=e.indexOf(":");return t<0?"":e.substr(0,t+1)}function od(e){if(!e)return null;const t=Number(e);return isNaN(t)?null:t}class ad{toJSON(){return ch("not implemented")}_getIdTokenResponse(e){return ch("not implemented")}_linkToIdToken(e,t){return ch("not implemented")}_getReauthenticationResolver(e){return ch("not implemented")}constructor(e,t){this.providerId=e,this.signInMethod=t}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function ud(e,t){return Ih(e,"POST","/v1/accounts:resetPassword",wh(e,t))}async function cd(e,t){return Ih(e,"POST","/v1/accounts:update",t)}async function ld(e,t){return Ih(e,"POST","/v1/accounts:sendOobCode",wh(e,t))}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class md{static parseLink(e){const t=function(e){const t=ir(rr(e)).link,n=t?ir(rr(t)).deep_link_id:null,i=ir(rr(e)).deep_link_id;return(i?ir(rr(i)).link:null)||i||n||t||e}(e);try{return new md(t)}catch(e){return null}}constructor(e){var t,n,i,r,s,o;const a=ir(rr(e)),u=null!==(t=a.apiKey)&&void 0!==t?t:null,c=null!==(n=a.oobCode)&&void 0!==n?n:null,l=function(e){switch(e){case"recoverEmail":return"RECOVER_EMAIL";case"resetPassword":return"PASSWORD_RESET";case"signIn":return"EMAIL_SIGNIN";case"verifyEmail":return"VERIFY_EMAIL";case"verifyAndChangeEmail":return"VERIFY_AND_CHANGE_EMAIL";case"revertSecondFactorAddition":return"REVERT_SECOND_FACTOR_ADDITION";default:return null}}(null!==(i=a.mode)&&void 0!==i?i:null);uh(u&&c&&l,"argument-error"),this.apiKey=u,this.operation=l,this.code=c,this.continueUrl=null!==(r=a.continueUrl)&&void 0!==r?r:null,this.languageCode=null!==(s=a.languageCode)&&void 0!==s?s:null,this.tenantId=null!==(o=a.tenantId)&&void 0!==o?o:null}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
class vd{static credential(e,t){return hd._fromEmailAndPassword(e,t)}static credentialWithLink(e,t){const n=md.parseLink(t);return uh(n,"argument-error"),hd._fromEmailAndCode(e,n.code,n.tenantId)}constructor(){this.providerId=vd.PROVIDER_ID}}vd.PROVIDER_ID="password",vd.EMAIL_PASSWORD_SIGN_IN_METHOD="password",vd.EMAIL_LINK_SIGN_IN_METHOD="emailLink";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Sd extends bd{static credentialFromResult(e){return Sd.samlCredentialFromTaggedObject(e)}static credentialFromError(e){return Sd.samlCredentialFromTaggedObject(e.customData||{})}static credentialFromJSON(e){const t=Cd.fromJSON(e);return uh(t,"argument-error"),t}static samlCredentialFromTaggedObject({_tokenResponse:e}){if(!e)return null;const{pendingToken:t,providerId:n}=e;if(!t||!n)return null;try{return Cd._create(n,t)}catch(e){return null}}constructor(e){uh(e.startsWith("saml."),"argument-error"),super(e)}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Vd(e,t,n){var i;uh((null===(i=n.url)||void 0===i?void 0:i.length)>0,e,"invalid-continue-uri"),uh(void 0===n.dynamicLinkDomain||n.dynamicLinkDomain.length>0,e,"invalid-dynamic-link-domain"),t.continueUrl=n.url,t.dynamicLinkDomain=n.dynamicLinkDomain,t.canHandleCodeInApp=n.handleCodeInApp,n.iOS&&(uh(n.iOS.bundleId.length>0,e,"missing-ios-bundle-id"),t.iOSBundleId=n.iOS.bundleId),n.android&&(uh(n.android.packageName.length>0,e,"missing-android-pkg-name"),t.androidInstallApp=n.android.installApp,t.androidMinimumVersionCode=n.android.minimumVersion,t.androidPackageName=n.android.packageName)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wd(e,t,n){const i=dr(e),r={requestType:"PASSWORD_RESET",email:t};n&&Vd(i,r,n),await async function(e,t){return ld(e,t)}(i,r)}async function zd(e,t){await async function(e,t){return Ih(e,"POST","/v1/accounts:update",wh(e,t))}(dr(e),{oobCode:t})}async function Kd(e,t){const n=dr(e),i=await ud(n,{oobCode:t}),r=i.requestType;switch(uh(r,n,"internal-error"),r){case"EMAIL_SIGNIN":break;case"VERIFY_AND_CHANGE_EMAIL":uh(i.newEmail,n,"internal-error");break;case"REVERT_SECOND_FACTOR_ADDITION":uh(i.mfaInfo,n,"internal-error");default:uh(i.email,n,"internal-error")}let s=null;return i.mfaInfo&&(s=$d._fromServerResponse(nd(n),i.mfaInfo)),{data:{email:("VERIFY_AND_CHANGE_EMAIL"===i.requestType?i.newEmail:i.email)||null,previousEmail:("VERIFY_AND_CHANGE_EMAIL"===i.requestType?i.email:i.newEmail)||null,multiFactorInfo:s},operation:r}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function Gd(e,t,n){const i=dr(e),r={requestType:"EMAIL_SIGNIN",email:t};uh(n.handleCodeInApp,i,"argument-error"),n&&Vd(i,r,n),await async function(e,t){return ld(e,t)}(i,r)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class uf{static _fromIdtoken(e,t){return new uf("enroll",e,t)}static _fromMfaPendingCredential(e){return new uf("signin",e)}toJSON(){return{multiFactorSession:{["enroll"===this.type?"idToken":"pendingCredential"]:this.credential}}}static fromJSON(e){var t,n;if(null==e?void 0:e.multiFactorSession){if(null===(t=e.multiFactorSession)||void 0===t?void 0:t.pendingCredential)return uf._fromMfaPendingCredential(e.multiFactorSession.pendingCredential);if(null===(n=e.multiFactorSession)||void 0===n?void 0:n.idToken)return uf._fromIdtoken(e.multiFactorSession.idToken)}return null}constructor(e,t,n){this.type=e,this.credential=t,this.auth=n}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
async function(e){return(await Ih(e,"GET","/v1/recaptchaParams")).recaptchaSiteKey||""}(this.auth);uh(e,this.auth,"internal-error"),this.parameters.sitekey=e}getAssertedRecaptcha(){return uh(this.recaptcha,this.auth,"internal-error"),this.recaptcha}constructor(e,t=Object.assign({},Uf),n){this.parameters=t,this.type="recaptcha",this.destroyed=!1,this.widgetId=null,this.tokenChangeListeners=new Set,this.renderPromise=null,this.recaptcha=null,this.auth=nd(n),this.isInvisible="invisible"===this.parameters.size,uh("undefined"!=typeof document,this.auth,"operation-not-supported-in-this-environment");const i="string"==typeof e?document.getElementById(e):e;uh(i,this.auth,"argument-error"),this.container=i,this.parameters.callback=this.makeTokenCallback(this.parameters.callback),this._recaptchaLoader=this.auth.settings.appVerificationDisabledForTesting?new Mf:new Df,this.validateStartingState()}}class Bf{confirm(e){const t=gd._fromVerification(this.verificationId,e);return this.onConfirmation(t)}constructor(e,t){this.verificationId=e,this.onConfirmation=t}}async function jf(e,t,n){var i;const r=await n.verify();try{let s;if(uh("string"==typeof r,e,"argument-error"),uh("recaptcha"===n.type,e,"argument-error"),s="string"==typeof t?{phoneNumber:t}:t,"session"in s){const t=s.session;if("phoneNumber"in s){uh("enroll"===t.type,e,"internal-error");const n=await
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * limitations under the License.
 */
function $f(e,t){return t?dh(t):(uh(e._popupRedirectResolver,e,"argument-error"),e._popupRedirectResolver)}
/**
 * @license
 * Copyright 2019 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)||(this.hasHandledPotentialRedirect=!0,t||(this.queuedRedirectEvent=e,t=!0)),t}sendToConsumer(e,t){var n;if(e.error&&!cp(e)){const i=(null===(n=e.error.code)||void 0===n?void 0:n.split("auth/")[1])||"internal-error";t.onError(rh(this.auth,i))}else t.onAuthEvent(e)}isEventForConsumer(e,t){const n=null===t.eventId||!!e.eventId&&e.eventId===t.eventId;return t.filter.includes(e.type)&&n}hasEventBeenHandled(e){return Date.now()-this.lastProcessedEventTime>=6e5&&this.cachedEventUids.clear(),this.cachedEventUids.has(up(e))}saveEventToCache(e){this.cachedEventUids.add(up(e)),this.lastProcessedEventTime=Date.now()}constructor(e){this.auth=e,this.cachedEventUids=new Set,this.consumers=new Set,this.queuedRedirectEvent=null,this.hasHandledPotentialRedirect=!1,this.lastProcessedEventTime=Date.now()}}function up(e){return[e.type,e.eventId,e.sessionId,e.tenantId].filter((e=>e)).join("-")}function cp({type:e,error:t}){return"unknown"===e&&"auth/no-auth-event"===(null==t?void 0:t.code)}async function lp(e,t={}){return Ih(e,"GET","/v1/projects",t)}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const bp=new mh(5e3,15e3),yp={style:{position:"absolute",top:"-100px",width:"1px",height:"1px"},"aria-hidden":"true",tabindex:"-1"},_p=new Map([["identitytoolkit.googleapis.com","p"],["staging-identitytoolkit.sandbox.googleapis.com","s"],["test-identitytoolkit.sandbox.googleapis.com","t"]]);function wp(e){const t=e.config;uh(t.authDomain,e,"auth-domain-config-required");const n=t.emulator?vh(t,"emulator/auth/iframe"):`https://${e.config.authDomain}/__/auth/iframe`,i={apiKey:t.apiKey,appName:e.name,v:ns},r=_p.get(e.config.apiHost);r&&(i.eid=r);const s=e._getFrameworks();return s.length&&(i.fw=s.join(",")),`${n}?${nr(i).slice(1)}`}
/**
 * @license
 * Copyright 2020 Google LLC.
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(t||"",a),new Ep(null);const h=window.open(t||"",a,l);uh(h,e,"popup-blocked");try{h.focus()}catch(e){}return new Ep(h)}function Sp(e,t,n,i,r,s){uh(e.config.authDomain,e,"auth-domain-config-required"),uh(e.config.apiKey,e,"invalid-api-key");const o={apiKey:e.config.apiKey,appName:e.name,authType:n,redirectUrl:i,v:ns,eventId:r};if(t instanceof bd){t.setDefaultLanguage(e.languageCode),o.providerId=t.providerId||"",Qi(t.getCustomParameters())||(o.customParameters=JSON.stringify(t.getCustomParameters()));for(const[e,t]of Object.entries(s||{}))o[e]=t}if(t instanceof yd){const e=t.getScopes().filter((e=>""!==e));e.length>0&&(o.scopes=e.join(","))}e.tenantId&&(o.tid=e.tenantId);const a=o;for(const e of Object.keys(a))void 0===a[e]&&delete a[e];return`${function({config:e}){return e.emulator?vh(e,"emulator/auth/handler"):`https://${e.authDomain}/__/auth/handler`}
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */(e)}?${nr(a).slice(1)}`}const kp=class{async _openPopup(e,t,n,i){var r;lh(null===(r=this.eventManagers[e._key()])||void 0===r?void 0:r.manager,"_initialize() not called before _openPopup()");return Cp(e,Sp(e,t,n,fh(),i),bf())}async _openRedirect(e,t,n,i){var r;return await this._originValidation(e),r=Sp(e,t,n,fh(),i),_f().location.href=r,new Promise((()=>{}))}_initialize(e){const t=e._key();if(this.eventManagers[t]){const{manager:e,promise:n}=this.eventManagers[t];return e?Promise.resolve(e):(lh(n,"If manager is not set, promise should be"),n)}const n=this.initAndGetManager(e);return this.eventManagers[t]={promise:n},n.catch((()=>{delete this.eventManagers[t]})),n}async initAndGetManager(e){const t=await async function(e){const t=await vp(e),n=_f().gapi;return uh(n,e,"internal-error"),t.open({where:document.body,url:wp(e),messageHandlersFilter:n.iframes.CROSS_ORIGIN_IFRAMES_FILTER,attributes:yp,dontclear:!0},(t=>new Promise((async(n,i)=>{await t.restyle({setHideOnLeave:!1});const r=rh(e,"network-request-failed"),s=_f().setTimeout((()=>{i(r)}),bp.get());function o(){_f().clearTimeout(s),n(t)}t.ping(o).then(o,(()=>{i(r)}))}))))}(e),n=new ap(e);return t.register("authEvent",(t=>{uh(null==t?void 0:t.authEvent,e,"invalid-auth-event");return{status:n.onEvent(t.authEvent)?"ACK":"ERROR"}}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER),this.eventManagers[e._key()]={manager:n},this.iframes[e._key()]=t,n}_isIframeWebStorageSupported(e,t){this.iframes[e._key()].send("webStorageSupport",{type:"webStorageSupport"},(n=>{var i;const r=null===(i=null==n?void 0:n[0])||void 0===i?void 0:i.webStorageSupport;void 0!==r&&t(!!r),ih(e,"internal-error")}),gapi.iframes.CROSS_ORIGIN_IFRAMES_FILTER)}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=async function(e){if(e.config.emulator)return;const{authorizedDomains:t}=await lp(e);for(const e of t)try{if(fp(e))return}catch(e){}ih(e,"unauthorized-domain")}(e)),this.originValidationPromises[t]}get _shouldInitProactively(){return Qh()||Vh()||Jh()}constructor(){this.eventManagers={},this.iframes={},this.originValidationPromises={},this._redirectPersistence=mf,this._completeRedirectFn=sp,this._overrideRedirectResult=Zf}};class Tp extends class{_process(e,t,n){switch(t.type){case"enroll":return this._finalizeEnroll(e,t.credential,n);case"signin":return this._finalizeSignIn(e,t.credential);default:return ch("unexpected MultiFactorSessionType")}}constructor(e){this.factorId=e}}{static _fromCredential(e){return new Tp(e)}_finalizeEnroll(e,t,n){return function(e,t){return Ih(e,"POST","/v2/accounts/mfaEnrollment:finalize",wh(e,t))}(e,{idToken:t,displayName:n,phoneVerificationInfo:this.credential._makeVerificationRequest()})}_finalizeSignIn(e,t){return function(e,t){return Ih(e,"POST","/v2/accounts/mfaSignIn:finalize",wh(e,t))}(e,{mfaPendingCredential:t,phoneVerificationInfo:this.credential._makeVerificationRequest()})}constructor(e){super("phone"),this.credential=e}}class Rp{static assertion(e){return Tp._fromCredential(e)}constructor(){}}Rp.FACTOR_ID="phone";
/**
 * @license
 * Copyright 2020 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Hp=class{async _initialize(e){const t=e._key();let n=this.eventManagers.get(t);return n||(n=new Mp(e),this.eventManagers.set(t,n),this.attachCallbackListeners(e,n)),n}_openPopup(e){ih(e,"operation-not-supported-in-this-environment")}async _openRedirect(e,t,n,i){!function(e){var t,n,i,r,s,o,a,u,c,l;const h=Lp();uh("function"==typeof(null===(t=null==h?void 0:h.universalLinks)||void 0===t?void 0:t.subscribe),e,"invalid-cordova-configuration",{missingPlugin:"cordova-universal-links-plugin-fix"}),uh(void 0!==(null===(n=null==h?void 0:h.BuildInfo)||void 0===n?void 0:n.packageName),e,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-buildInfo"}),uh("function"==typeof(null===(s=null===(r=null===(i=null==h?void 0:h.cordova)||void 0===i?void 0:i.plugins)||void 0===r?void 0:r.browsertab)||void 0===s?void 0:s.openUrl),e,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-browsertab"}),uh("function"==typeof(null===(u=null===(a=null===(o=null==h?void 0:h.cordova)||void 0===o?void 0:o.plugins)||void 0===a?void 0:a.browsertab)||void 0===u?void 0:u.isAvailable),e,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-browsertab"}),uh("function"==typeof(null===(l=null===(c=null==h?void 0:h.cordova)||void 0===c?void 0:c.InAppBrowser)||void 0===l?void 0:l.open),e,"invalid-cordova-configuration",{missingPlugin:"cordova-plugin-inappbrowser"})}(e);const r=await this._initialize(e);await r.initialized(),r.resetRedirect(),Jf.clear(),await this._originValidation(e);const s=function(e,t,n=null){return{type:t,eventId:n,urlResponse:null,sessionId:Bp(),postBody:null,tenantId:e.tenantId,error:rh(e,"no-auth-event")}}(e,n,i);await function(e,t){return jp()._set(qp(e),t)}(e,s);const o=await xp(e,s,t);return async function(e,t,n){const{cordova:i}=Lp();let r=()=>{};try{await new Promise(((s,o)=>{let a=null;function u(){var e;s();const t=null===(e=i.plugins.browsertab)||void 0===e?void 0:e.close;"function"==typeof t&&t(),"function"==typeof(null==n?void 0:n.close)&&n.close()}function c(){a||(a=window.setTimeout((()=>{o(rh(e,"redirect-cancelled-by-user"))}),2e3))}function l(){"visible"===(null===document||void 0===document?void 0:document.visibilityState)&&c()}t.addPassiveListener(u),document.addEventListener("resume",c,!1),Kh()&&document.addEventListener("visibilitychange",l,!1),r=()=>{t.removePassiveListener(u),document.removeEventListener("resume",c,!1),document.removeEventListener("visibilitychange",l,!1),a&&window.clearTimeout(a)}}))}finally{r()}}(e,r,await Dp(o))}_isIframeWebStorageSupported(e,t){throw new Error("Method not implemented.")}_originValidation(e){const t=e._key();return this.originValidationPromises[t]||(this.originValidationPromises[t]=async function(e){const{BuildInfo:t}=Lp(),n={};Jh()?n.iosBundleId=t.packageName:Kh()?n.androidPackageName=t.packageName:ih(e,"operation-not-supported-in-this-environment"),await lp(e,n)}(e)),this.originValidationPromises[t]}attachCallbackListeners(e,t){const{universalLinks:n,handleOpenURL:i,BuildInfo:r}=Lp(),s=setTimeout((async()=>{await Up(e),t.onEvent(Vp())}),500),o=async n=>{clearTimeout(s);const i=await Up(e);let r=null;i&&(null==n?void 0:n.url)&&(r=Fp(i,n.url)),t.onEvent(r||Vp())};void 0!==n&&"function"==typeof n.subscribe&&n.subscribe(null,o);const a=i,u=`${r.packageName.toLowerCase()}://`;Lp().handleOpenURL=async e=>{if(e.toLowerCase().startsWith(u)&&o({url:e}),"function"==typeof a)try{a(e)}catch(e){console.error(e)}}}constructor(){this._redirectPersistence=mf,this._shouldInitProactively=!0,this.eventManagers=new Map,this.originValidationPromises={},this._completeRedirectFn=sp,this._overrideRedirectResult=Zf}};function Vp(){return{type:"unknown",eventId:null,sessionId:null,urlResponse:null,postBody:null,tenantId:null,error:rh("no-auth-event")}}
/**
 * @license
 * Copyright 2017 Google LLC
 *
 ...
 * limitations under the License.
 */
const mg=uh;class vg{clear(){this._delegate.clear()}render(){return this._delegate.render()}verify(){return this._delegate.verify()}constructor(e,t,n=Fl.app()){var i;mg(null===(i=n.options)||void 0===i?void 0:i.apiKey,"invalid-api-key",{appName:n.name}),this._delegate=new Ff(e,t,n.auth()),this.type=this._delegate.type}}
/**
 * @license
 * Copyright 2020 Google LLC
 *
